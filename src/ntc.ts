...
//   name: function (color: string): [string, string, boolean] {
...
export const name = (color: string): [string, string, boolean] => {
  color = color.toUpperCase();
  if (color.length < 3 || color.length > 7)
    return ["#000000", "Invalid Color: " + color, false];
  if (color.length % 3 === 0) color = "#" + color;
...
const hslFromColor = (color: string): number[] => {
  let rgb = [
    parseInt("0x" + color.substring(1, 3)) / 255,
    parseInt("0x" + color.substring(3, 5)) / 255,
    parseInt("0x" + color.substring(5, 7)) / 255,
...
const rgbFromColor = (color: string): number[] => {
  return [
    parseInt("0x" + color.substring(1, 3)),
    parseInt("0x" + color.substring(3, 5)),
    parseInt("0x" + color.substring(5, 7)),
